...
class MAVAndWaypointViewer:
    ...
    def update(self, state, path, waypoints, boxstate, delivery_zone):
        ...
        if not self.plot_initialized:
            ...
            self.delivery_plot = DrawPath(delivery_zone._path1, green, self.window)
            self.delivery_plot = DrawPath(delivery_zone._path2, green, self.window)
